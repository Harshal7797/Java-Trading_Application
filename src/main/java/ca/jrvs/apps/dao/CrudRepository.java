...
/**
 * Interface for generics CRUD operation on a repository for a Specific Type.
 */
public interface CrudRepository<E, ID> {
    ...
    /**
     * Return Weather an entity with the given id exists.
     *
     * @param id must not be {@literal null}
     ...
     * @throws IllegalArgumentException if {@code id} is {@literal null}
     * @throws java.sql.SQLException if sql execution failed
     * @throws ResourceNotFoundException if no entity found in db
     */
