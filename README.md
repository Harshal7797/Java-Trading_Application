...
-  The technology used to implement this Micro Service is `SpringBoot`. `PSQL` database is used to persist information regarding quote, account, etc. IEX Cloud is used to get data for stock and persist them into the database. 
...
5.
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE1OTczNjU4NCwtMTA4OTI4ODE3NCwtMT
