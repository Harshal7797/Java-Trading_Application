...
- briefly explain the following logic layers or components (3-5 sentences for each)  
  ...
  - `Service` : This component is knows as Business logic. In computer software a business logic is the part of program that encodes the real-world business rules that determines how data can be created, stored and changed.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTYyOTEwMDQ4LDE1MTQwMTkyNDgsMTY5ND
