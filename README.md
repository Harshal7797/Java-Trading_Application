...
-  The technology used to implement this Micro Service is `SpringBoot`. `PSQL` database is used to persist information  regarding quote, account, etc. 
...
5.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5OTczNDA4OTMsLTEwODkyODgxNzQsLT
