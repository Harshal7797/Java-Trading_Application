...
- briefly explain the following logic layers or components (3-5 sentences for each)  
  ...
  - `Dao` : Data Access Object which handles various object. DAO is used to map the retrieved information from `IEX Cloud` and then latter use it to presist data into `PSQL` database. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMzk5MDYzMjYsMTUxNDAxOTI0OCwxNj
