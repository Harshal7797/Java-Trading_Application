...
-  The technology used to implement this Micro Service is `SpringBoot`. `PSQL` databse is used to persist information  
...
5.
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMzExNzM4MDgsLTEwODkyODgxNzQsLT
